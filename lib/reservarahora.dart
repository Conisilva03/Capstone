...
class _ReservarAhoraScreenState extends State<ReservarAhoraScreen> {
  ...
  Future<void> initializeData() async {
    ...
    horaController..text = selectedTime.toString().substring(10, 15);
...
// Extract the license plate from the car data
  ...
  Future<void> sendReceiptEmail({
    ...
    final url =
        Uri.parse('https://api2.parkingtalcahuano.cl/send_receipt_email');
            ...
            builder: (context) => ConfirmationScreen(
              ...
              onAccept: () async {
                ...
                Map<String, dynamic> carData =
                    await fetchUserCarData(userId ?? 0);
